...
namespace TextureToolUpdater
{
	public partial class FormMain : Form
	{
		...
		private string ServerXML = "http://www.pckstudio.tk/studio/Texture/update.xml";

		private string appData = Environment.GetFolderPath(Environment.SpecialFolder.Personal) + "\\Texture Builder\\";

		private string localFile = Environment.CurrentDirectory + "\\MinecraftTextureBuilder.exe";
		...
		public void downloadUpdate()
		{
			try
			{
				foreach (Process proc in Process.GetProcessesByName("MinecraftTextureBuilder"))
				{
					proc.Kill();
				}
			}
